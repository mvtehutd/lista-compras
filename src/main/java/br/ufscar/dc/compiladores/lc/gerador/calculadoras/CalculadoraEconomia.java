...
/**
 * Calcula a lista de compras baseado no Fator Economia
 */
public class CalculadoraEconomia extends CalculadoraBase {
    ...
    public String retornaListaDeCompras(TabelaDeSimbolos tabela) {
        ...
        // Retorna o html Gerado pelo metodo a partir da lista de comprar separada por loja
